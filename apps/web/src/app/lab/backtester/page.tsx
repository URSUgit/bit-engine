...
const TradeEditor = dynamic(() => import("./components/trade-editor").then((m) => m.TradeEditor), { ssr: false, loading: () => <TabSkeleton /> });
const MonthlyBreakdown = dynamic(() => import("./components/monthly-breakdown").then((m) => m.MonthlyBreakdown), { ssr: false, loading: () => <TabSkeleton /> });
import { MetadataPanel } from "./components/metadata-panel";
const CompareTable = dynamic(() => import("./components/compare-table").then((m) => m.CompareTable), { ssr: false, loading: () => <TabSkeleton /> });
const OptimizeHeatmap = dynamic(() => import("./components/optimize-heatmap").then((m) => m.OptimizeHeatmap), { ssr: false, loading: () => <TabSkeleton /> });
const DataStatusTab = dynamic(() => import("./components/data-status").then((m) => m.DataStatusTab), { ssr: false, loading: () => <TabSkeleton /> });
const StrategyScannerView = dynamic(() => import("./components/strategy-scanner").then((m) => m.StrategyScannerView), { ssr: false, loading: () => <TabSkeleton /> });
import { BacktesterChat } from "./components/chat-panel";
const MonteCarloPanel = dynamic(() => import("./components/monte-carlo").then((m) => m.MonteCarloPanel), { ssr: false, loading: () => <TabSkeleton /> });
const ForwardTest = dynamic(() => import("./components/forward-test").then((m) => m.ForwardTest), { ssr: false, loading: () => <TabSkeleton /> });
import { KeyboardShortcutsLayer } from "./components/keyboard-shortcuts";
const WalkForwardPanel = dynamic(() => import("./components/walk-forward").then((m) => m.WalkForwardPanel), { ssr: false, loading: () => <TabSkeleton /> });
const CustomStrategyEditor = dynamic(() => import("./components/custom-strategy-editor").then((m) => m.CustomStrategyEditor), { ssr: false, loading: () => <TabSkeleton /> });
const ConditionBuilder = dynamic(() => import("./components/condition-builder").then((m) => m.ConditionBuilder), { ssr: false, loading: () => <TabSkeleton /> });
const PortfolioView = dynamic(() => import("./components/portfolio-view").then((m) => m.PortfolioView), { ssr: false, loading: () => <TabSkeleton /> });
const RollingAnalysisPanel = dynamic(() => import("./components/rolling-analysis").then((m) => m.RollingAnalysisPanel), { ssr: false, loading: () => <TabSkeleton /> });
const HeatCalendar = dynamic(() => import("./components/heat-calendar").then((m) => m.HeatCalendar), { ssr: false, loading: () => <TabSkeleton /> });
const KellyPanel = dynamic(() => import("./components/kelly-panel").then((m) => m.KellyPanel), { ssr: false, loading: () => <TabSkeleton /> });
const SensitivityChart = dynamic(() => import("./components/sensitivity-chart").then((m) => m.SensitivityChart), { ssr: false, loading: () => <TabSkeleton /> });
const RegimeAnalysis = dynamic(() => import("./components/regime-analysis").then((m) => m.RegimeAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const StrategyLeaderboard = dynamic(() => import("./components/strategy-leaderboard").then((m) => m.StrategyLeaderboard), { ssr: false, loading: () => <TabSkeleton /> });
const RiskAnalyticsPanel = dynamic(() => import("./components/risk-analytics").then((m) => m.RiskAnalyticsPanel), { ssr: false, loading: () => <TabSkeleton /> });
const EfficientFrontier = dynamic(() => import("./components/efficient-frontier").then((m) => m.EfficientFrontier), { ssr: false, loading: () => <TabSkeleton /> });
const PerformanceAttribution = dynamic(() => import("./components/performance-attribution").then((m) => m.PerformanceAttribution), { ssr: false, loading: () => <TabSkeleton /> });
const SymbolScanner = dynamic(() => import("./components/symbol-scanner").then((m) => m.SymbolScanner), { ssr: false, loading: () => <TabSkeleton /> });
const DrawdownAnalysis = dynamic(() => import("./components/drawdown-analysis").then((m) => m.DrawdownAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
import { ConfigPresets, type BacktestConfig } from "./components/config-presets";
const TradeJournal = dynamic(() => import("./components/trade-journal").then((m) => m.TradeJournal), { ssr: false, loading: () => <TabSkeleton /> });
const MultiTimeframePanel = dynamic(() => import("./components/multi-timeframe").then((m) => m.MultiTimeframePanel), { ssr: false, loading: () => <TabSkeleton /> });
import { Watchlist } from "./components/watchlist";
const StrategyRadar = dynamic(() => import("./components/strategy-radar").then((m) => m.StrategyRadar), { ssr: false, loading: () => <TabSkeleton /> });
...
const RobustnessTest = dynamic(() => import("./components/robustness-test").then((m) => m.RobustnessTest), { ssr: false, loading: () => <TabSkeleton /> });
import { PositionSizer } from "./components/position-sizer";
const FactorExposure = dynamic(() => import("./components/factor-exposure").then((m) => m.FactorExposure), { ssr: false, loading: () => <TabSkeleton /> });
const TradeTimingAnalysis = dynamic(() => import("./components/trade-timing").then((m) => m.TradeTimingAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const StrategyMatrix = dynamic(() => import("./components/strategy-matrix").then((m) => m.StrategyMatrix), { ssr: false, loading: () => <TabSkeleton /> });
const DiversificationPanel = dynamic(() => import("./components/diversification").then((m) => m.DiversificationPanel), { ssr: false, loading: () => <TabSkeleton /> });
const ReportExport = dynamic(() => import("./components/report-export").then((m) => m.ReportExport), { ssr: false, loading: () => <TabSkeleton /> });
const LivePnlSimulator = dynamic(() => import("./components/live-pnl-simulator").then((m) => m.LivePnlSimulator), { ssr: false, loading: () => <TabSkeleton /> });
const MarketCorrelation = dynamic(() => import("./components/market-correlation").then((m) => m.MarketCorrelation), { ssr: false, loading: () => <TabSkeleton /> });
const TradeStreakAnalyzer = dynamic(() => import("./components/trade-streak").then((m) => m.TradeStreakAnalyzer), { ssr: false, loading: () => <TabSkeleton /> });
const ProfitDistribution = dynamic(() => import("./components/profit-distribution").then((m) => m.ProfitDistribution), { ssr: false, loading: () => <TabSkeleton /> });
const StrategyBenchmark = dynamic(() => import("./components/strategy-benchmark").then((m) => m.StrategyBenchmark), { ssr: false, loading: () => <TabSkeleton /> });
const EnsemblePanel = dynamic(() => import("./components/ensemble-panel").then((m) => m.EnsemblePanel), { ssr: false, loading: () => <TabSkeleton /> });
const IntradayHeatmap = dynamic(() => import("./components/intraday-heatmap").then((m) => m.IntradayHeatmap), { ssr: false, loading: () => <TabSkeleton /> });
const TradeQuality = dynamic(() => import("./components/trade-quality").then((m) => m.TradeQuality), { ssr: false, loading: () => <TabSkeleton /> });
const BenchmarkTracker = dynamic(() => import("./components/benchmark-tracker").then((m) => m.BenchmarkTracker), { ssr: false, loading: () => <TabSkeleton /> });
const ScenarioComparator = dynamic(() => import("./components/scenario-comparator").then((m) => m.ScenarioComparator), { ssr: false, loading: () => <TabSkeleton /> });
const TradeAutocorrelation = dynamic(() => import("./components/trade-autocorrelation").then((m) => m.TradeAutocorrelation), { ssr: false, loading: () => <TabSkeleton /> });
const MaeMfeAnalysis = dynamic(() => import("./components/mae-mfe-analysis").then((m) => m.MaeMfeAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const PineScriptExport = dynamic(() => import("./components/pinescript-export").then((m) => m.PineScriptExport), { ssr: false, loading: () => <TabSkeleton /> });
const BreakevenAnalysis = dynamic(() => import("./components/breakeven-analysis").then((m) => m.BreakevenAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const SignificancePanel = dynamic(() => import("./components/significance-panel").then((m) => m.SignificancePanel), { ssr: false, loading: () => <TabSkeleton /> });
const StrategyAdvisor = dynamic(() => import("./components/strategy-advisor").then((m) => m.StrategyAdvisor), { ssr: false, loading: () => <TabSkeleton /> });
const SeasonalityAnalysis = dynamic(() => import("./components/seasonality-analysis").then((m) => m.SeasonalityAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const RiskOfRuin = dynamic(() => import("./components/risk-of-ruin").then((m) => m.RiskOfRuin), { ssr: false, loading: () => <TabSkeleton /> });
const EvExplorer = dynamic(() => import("./components/ev-explorer").then((m) => m.EvExplorer), { ssr: false, loading: () => <TabSkeleton /> });
const TradeReplay = dynamic(() => import("./components/trade-replay").then((m) => m.TradeReplay), { ssr: false, loading: () => <TabSkeleton /> });
const LongShortAnalysis = dynamic(() => import("./components/long-short-analysis").then((m) => m.LongShortAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const PositionSizingWizard = dynamic(() => import("./components/position-sizing-wizard").then((m) => m.PositionSizingWizard), { ssr: false, loading: () => <TabSkeleton /> });
const SharpeContribution = dynamic(() => import("./components/sharpe-contribution").then((m) => m.SharpeContribution), { ssr: false, loading: () => <TabSkeleton /> });
const ExitAnalysis = dynamic(() => import("./components/exit-analysis").then((m) => m.ExitAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const StreakDistribution = dynamic(() => import("./components/streak-distribution").then((m) => m.StreakDistribution), { ssr: false, loading: () => <TabSkeleton /> });
const CostSensitivity = dynamic(() => import("./components/cost-sensitivity").then((m) => m.CostSensitivity), { ssr: false, loading: () => <TabSkeleton /> });
const PerformanceDecay = dynamic(() => import("./components/performance-decay").then((m) => m.PerformanceDecay), { ssr: false, loading: () => <TabSkeleton /> });
const DynamicSizing = dynamic(() => import("./components/dynamic-sizing").then((m) => m.DynamicSizing), { ssr: false, loading: () => <TabSkeleton /> });
const ClusterAnalysis = dynamic(() => import("./components/cluster-analysis").then((m) => m.ClusterAnalysis), { ssr: false, loading: () => <TabSkeleton /> });
const CapitalEfficiency = dynamic(() => import("./components/capital-efficiency").then((m) => m.CapitalEfficiency), { ssr: false, loading: () => <TabSkeleton /> });
...
function TabSkeleton() {
  return (
    <div className="h-64 bg-zinc-900/50 border border-zinc-800 rounded-lg animate-pulse flex items-center justify-center text-zinc-600 text-sm">
      Loading…
    </div>
  );
}
  ...
  const groups: TabGroup[] = [
    ...
    },
    {
      ...
      tabs: [
        ...
        { value: "strategy_advisor" as ResultTab, label: "Advisor" },
      ],
    },
    {
      label: "Optimize",
